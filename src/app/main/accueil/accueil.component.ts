...
export class AccueilComponent {
  ...
  constructor(
    ...
    /*let role_use = this.currentUser.roles;
    this.menuadmin = false;
    this.menuchfhier = false;
    console.log(role_use);
    console.log(this.menuadmin);
    console.log(this.menuchfhier);
    role_use.forEach(element => {
      if (element == 'chfhier') {
        this.menuadmin = false;
        this.menuchfhier = false;
      }
    ...
    this._fuseNavigationService.updateNavigationItem('Administration', {
      ...
      hidden: this.menuadmin
    });
    this._fuseNavigationService.updateNavigationItem('db', {

      hidden: this.menuadmin
    });
    this._fuseNavigationService.updateNavigationItem('mission', {

      hidden: this.menuchfhier
    });
    this._fuseNavigationService.updateNavigationItem('aut', {
